...
const root = {
  apiKeys: {
    // leeave empty to disable API keys (public access)
    JFSDFHl340udfnsf23SF234: true, // set to false to disable a key
  },
  updateUrl: "",
  mongoUrl:
    process.env.WOLF_CONTAINER === "docker"
      ? "mongodb://mongodb:27017/wolfbot"
      : // put your MongoDB connection URL in here: mongodb://user:password@host:port/database
        "mongodb://admin:admin@localhost:27017/wolf?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&ssl=false",
...
export const currencyImportMap = new Map<
  MultipleCurrencyImportExchange,
  Currency.CurrencyPair[]
>([]);
export const liveTradeImportMap = new Map<
  MultipleCurrencyImportExchange,
  Currency.CurrencyPair[]
>([]);
